...
export default function AdminDashboardPage() {
  ...
  const [revenueData, setRevenueData] =
    useState<RevenueStatistic[]>([]);

  const [orderStatusData, setOrderStatusData] =
    useState<OrderStatusStatistic[]>([]);
  ...
  const [topToppings, setTopToppings] =
    useState<TopTopping[]>([]);
  ...
  const [
    paymentStatistics,
    setPaymentStatistics,
  ] = useState<PaymentStatistics | null>(
    null,
  );

  const [
    voucherStatistics,
    setVoucherStatistics,
  ] = useState<VoucherStatistics | null>(
    null,
  );
